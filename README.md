...
The latest dictionary file is available in `dist/dictionary.mobi`. Simply copy it to your Kindle's `documents` folder.
...
# Convert to .mobi (requires kindlegen or Kindle Previewer)
